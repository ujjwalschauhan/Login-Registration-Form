...
if (isset($_POST['createTodo'])) {
  ...
  if (empty($errors)) {
    ...
    $sql = "INSERT INTO `tasks` (`task`, `description`, `priority`, `due_date`, `status`, `user_id`) VALUES ('$task', '$description', '$priority', '$date', '$status',NULL)";
...
<br><br><br><br><br><br><br>
    <form method="post">               
        ...
        <div class="form-group ">
          ...
          <input type="date" class="form-control" id="date" name="date" min="<?php echo date("Y-m-d"); ?>" value="<?php echo  isset($_POST['date']) ?  $_POST['due_date'] : ''; ?>">
          ...
          <tr>
            ...
            <td>
                <form method="POST" action="">
                    <button type="submit" name="deleteTask" class="btn btn-danger my-2 my-sm-0" value= <?php echo $row['id']; ?>>Delete</button>
                </form>
            </td>
          </tr>
        <?php } ?>
